...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_observable_of__ = __webpack_require__(18);
...
let stream$ = __WEBPACK_IMPORTED_MODULE_0_rxjs_Observable__["Observable"]
  .of(1,2,3)
  .map(x => {
    throw new Error(x);
    return x + '!!!';
